...
// shows up and we have 30 elements or
// more animating, it would not longer be
// efficient to wrap each one in a separate
// transition component. So, we use the 
// lifecycle methods to hook into the same event
// that the transition hook is using under the hook: mounted()
var Droparea = {
  template: '#droparea',
  mounted: function mounted() {
...
var Windarea = {
  template: '#windarea',
  mounted: function mounted() {
    var audio = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/wind.mp3'),
        tl = new TimelineMax(),
...
var Rainbowarea = {
  ...
  mounted: function mounted() {
    var audio = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/rainbow.mp3'),
        tl = new TimelineMax();
...
var Tornadoarea = {
  ...
  mounted: function mounted() {
    var audio = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/tornado.mp3'),
        tl = new TimelineMax();
...
var app = new Vue({
  ...
  methods: {
    ...
    beforeEnterStroke: function beforeEnterStroke(el) {
      el.style.strokeWidth = 0;
      el.style.stroke = 'orange';
    },
    enterStroke: function enterStroke(el, done) {
      var tl = new TimelineMax({
        onComplete: done
      });
    ...
    leaveDroparea: function leaveDroparea(el, done) {
      var tl = new TimelineMax({
        onComplete: done
      });
    ...
    leaveDialog: function leaveDialog(el, done) {
      var tl = new TimelineMax({
        onComplete: done
      });
